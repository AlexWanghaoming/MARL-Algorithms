...
def get_common_args():
    ...
    parser.add_argument('--n_steps', type=int, default=2e6, help='total time steps')
    ...
    parser.add_argument('--use_action_mask', type=bool, default=True, help='whether to mask legal actions')
