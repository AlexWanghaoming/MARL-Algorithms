...
def get_common_args():
    ...
    parser.add_argument('--n_steps', type=int, default=1e7, help='total time steps')
    ...
    parser.add_argument('--use_action_mask', type=bool, default=False, help='whether to mask legal actions')
...
def get_mixer_args(args):
    ...
    # experience replay 都是以episode为单位的
    args.batch_size = 32
