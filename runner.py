...
class Runner:
    def __init__(self, env, args):
        ...
        if args.env_name == 'smac':
            from common.smac_rollout import RolloutWorker, CommRolloutWorker
        else:
            from common.overcooked_rollout import RolloutWorker, CommRolloutWorker
    ...
    def run(self, num):
        ...
        while time_steps < self.args.n_steps:
            ...
            for episode_idx in range(self.args.n_episodes):  # args.n_episodes = 1
                episode, _, _,  steps = self.rolloutWorker.generate_episode(episode_idx, time_steps)
